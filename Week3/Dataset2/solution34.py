...
def q1_build_graph(graph):
    ...
    q1_add_edge('bob', 'dana', graph)
    q1_add_edge('alice', 'dana', graph)
...
def q2_build_graph(graph):
    ...
    q2_build_graph('A', 'C', graph)
    q2_build_graph('A', 'B', graph)
    q2_build_graph('B', 'D', graph)
    q2_build_graph('B', 'E', graph)
    q2_build_graph('C', 'D', graph)
    q2_build_graph('C', 'E', graph)
    q2_build_graph('D', 'F', graph)
    q2_build_graph('E', 'F', graph)
