...
with open('books.txt', 'r',encoding="UTF-8") as f:
    hashtable.create_table(10)
    for line in f:
        line = line.strip()
        index=hashtable.hash4_b(line)
        hashtable.add_element(line)
print(f'Number of collision is {collision}') # should be 90
print(hashtable.search('a clockwork orange'))          # should return True
print(hashtable.search('1984'))                        # should return True
print(hashtable.search('game of throne'))              # should return False
print(hashtable.search('foundation'))                  # should return False
