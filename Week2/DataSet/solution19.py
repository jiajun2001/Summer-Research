...
print(hash1('adelaide', 10))
print(hash2('adelaide', 10))
print(hash3('adelaide', 10))
...
def check_dup(li):
    ...
    # ~ 7 lines
    return not len(li) == len(set(li))
print(check_dup([1,3,1,2]))
print(check_dup([1,2,3,4]))
...
def two_sum(li, target):
    ...
    for i in range(len(li)):
        if li[i] in dictionary:
            return [i, dictionary[li[i]]]
        dictionary[target - li[i]] = i
    return None
# ---------------            
# TEST CASE BELOW
